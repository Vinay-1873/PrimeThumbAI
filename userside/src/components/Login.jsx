...
const Login = () => {
  ...
  return (
    <>
    <SoftBackdrop/>
    <div className='min-h-screen flex items-center justify-center pt-12 pb-24'>
            <form
                onSubmit={handleSubmit}
                className="max-w-md w-full sm:w-87.5 text-center bg-white/6 border border-white/10 rounded-2xl px-6 py-6">
                ...
                <div className="flex items-center w-full mt-3 bg-white/5 ring-2 ring-white/10 focus-within:ring-indigo-500/60 h-12 rounded-full overflow-hidden pl-6 gap-2 transition-all ">
                ...
                <div className=" flex items-center mt-3 w-full bg-white/5 ring-2 ring-white/10 focus-within:ring-indigo-500/60 h-12 rounded-full overflow-hidden pl-6 gap-2 transition-all ">
                ...
                <button type="submit" className="mt-4 w-full h-11 rounded-full text-white bg-indigo-600 hover:bg-indigo-500 transition " >
                    {state === "login" ? "Login" : "Sign up"}
                </button>
